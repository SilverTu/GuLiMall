package org.tshc.coupon.controller;
...
public class CouponController {
  ...
  public R memberList(@PathVariable("memberLevel") Integer memberLevel) {
    return R.ok().put("data", couponService.list(
        Wrappers.<CouponEntity>lambdaQuery().eq(CouponEntity::getMemberLevel, memberLevel)));
  }
}
